...
async function criarProjeto() {
  const titulo = document.getElementById("tituloCri").value.trim();
  const descricao = document.getElementById("descricaoCri").value.trim();
  const dataEntrega = document.getElementById("dataEntregaCri").value;
  let arquivo = document.getElementById("arquivoCri").files[0];
  const msgAviso = document.getElementById("msgAvisoCri");
  msgAviso.innerHTML = "";

  if (titulo === "") {
    msgAviso.innerHTML = "Preencha o campo Título!";
    document.getElementById("tituloCri").focus();
    return;
  } else if (descricao === "") {
    msgAviso.innerHTML = "Preencha o campo Descrição!";
    document.getElementById("descricaoCri").focus();
    return;
    ...
    document.getElementById("dataEntregaCri").focus();
    return;
  }
...
function fecharPopupProjeto() {
    document.getElementById("criarProjetoPopup").style.display = "none";
    document.body.style.overflow = "";
}

async function abrirPopupProjeto() {
    document.getElementById("criarProjetoPopup").style.display = "flex";
    document.body.style.overflow = "hidden";
}